...
const Data = () => {
  return (
   <div className="home__data">
    <h1 data-aos="zoom-in-top"
        data-aos-delay="1500"
        data-aos-easing="ease-in-sine"
        className="home__title">Kishore   
     <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <h3 data-aos="zoom-in-left"
        data-aos-delay="1500"
        data-aos-easing="ease-in-sine" 
        className="home__subtitle">Web Developer</h3>

    <p  data-aos="fade-up"
        data-aos-duration="3000"
        className="home__description">I'm creative FullStack Devloper, Web Designer
